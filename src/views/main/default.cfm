	...
	<div style="float:right;">
		<cfoutput>
			<form onsubmit="return false;">
				...
				<input type="text" name="textSearch" id="textSearch" value="#rc.filters.textSearch#" onkeyup="dtTimerSearch();" onmouseup="dtTimerSearch();">
        ...
        "columns": [
            ...
            , {
				...
				"render": function ( data, type, full, meta ) {
					<cfoutput>return '<a href="#buildUrl(action="main.server")#&serverId=' + full.Id + '">' + data + '</a>';</cfoutput>
				}
            }
            , { "data": "clientName" }
            , { "data": "serverType" }
